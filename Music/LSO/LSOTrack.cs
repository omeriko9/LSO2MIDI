...
namespace ConvertLSO
{
    public class Track
    {
        ...
        const int TrackStart4 = 0x000200CA; // LSO v5
        ...
        public int TrackMIDIStart { get; private set; } 
        ...
        {
            header &= 0xFFFFFF;
            return header == TrackStart || header == TrackStart2 || header == TrackStart3 || header == TrackStart4;
        }
